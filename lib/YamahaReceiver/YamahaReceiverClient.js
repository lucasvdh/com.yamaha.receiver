                ...
                return this.get(zone, '<Play_Info>GetParam</Play_Info>').then(xmlResponse => {
                    return xml2js.parseStringPromise(xmlResponse)
                        .then(result => {
                            ...
                            playInfo.artist = this.getArtistFromMeta(metaInfoResult);
                            playInfo.album = this.getAlbumFromMeta(metaInfoResult);
                            playInfo.track = this.getTrackFromMeta(metaInfoResult);
