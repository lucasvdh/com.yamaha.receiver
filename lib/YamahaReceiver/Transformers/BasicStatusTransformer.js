            ...
            xml2js.parseStringPromise(xmlResponse)
                .then(result => {
                    try {
                        ...
                        Log.addBreadcrumb(
                            'basic_status_transformer',
                            'Something went wrong while transforming the basic status result',
                            {
                        ...
                        reject('Something went wrong while transforming the basic status result');
                    }
                }).catch(error => {
                Log.addBreadcrumb(
                    'basic_status_transformer',
